...
import { People24Filled, MusicNote124Filled, List24Filled, Album24Filled } from '@vicons/fluent'
...
const onSelect = (key: string, option: DropdownOption) => {
  ...
  console.log('key, option.keyType')
...
<template>
  <div style="width: 500px;">
    <n-dropdown style="width: 500px;" :options="searchResultsOption" trigger="manual" :show="dropdownShow" @select="onSelect">
      <n-input :placeholder="`猜你想搜: ${maybeSearch}`" @blur="onBlur" @input="onInput" @focus="onFocus" v-model:value="value" />
    </n-dropdown>
  </div>
</template>